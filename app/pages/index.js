...
Index.getInitialProps = async (ctx) => {
  ...
  let res;
  if (process.browser) {
    res = await fetch("https://www.api.piotrpolcik.pl/projects", {
      headers: {
        cookie: `lang=${lang}`,
  ...
  const supportsWebP = true; //ctx.req.headers.accept.match('image/webp');
  if (res.status === 200) {
    ...
    return {
      ...
      home: {
        bg: supportsWebP
          ? "/static/images/bg_full.webp"
          : "/static/images/bg_full.jpg",
        bgMoving: supportsWebP
          ? "/static/images/bg_bt_trans.webp"
          : "/static/images/bg_bt_trans.png",
      },
      about: {
        img: supportsWebP
          ? "/static/images/me_bw.webp"
          : "/static/images/me_bw.jpg",
      },
      lang: lang,
    };
  }
