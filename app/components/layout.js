  ...
  return (
    <JssProvider id={{ minify: true }}>
      ...
      <Head>
        ...
        <meta
          name="description"
          content={props.content.meta.description}
        ></meta>
        ...
        <meta
          property="og:image"
          content={getWebsiteRootUrl() + props.og.image}
        />
        ...
        <link
          rel="shortcut icon"
          type="image/png"
          href="/static/images/Logo_light.png"
        />
        <script
          defer
      ...
      <Navbar
        styling={props.navbar}
        social={props.content.social}
        content={props.content.navbar}
        colorSchema={colorSchema}
      />
      <div className="container px-0 mx-0">{props.children}</div>
    </JssProvider>
  );
};
